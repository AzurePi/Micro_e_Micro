...
#define VERMELHO PORTB,2     ; Define o pino 2 do PORTB como VERMELHO (LED)
...
MAIN:
    ...
    BSF VERMELHO         ; Seta o bit VERMELHO (PORTB,2), ligando o LED
    MOVLW 12             ; A instrução MOVLW 12 carrega o valor literal 12 no registrador de trabalho (WREG).
    CALL ATRASO          ; Chama a sub-rotina ATRASO
    BCF VERMELHO         ; Reseta o bit VERMELHO (PORTB,2), desligando o LED
    MOVLW 12		 ; A instrução MOVLW 12 carrega o valor literal 12 no registrador de trabalho (WREG).
